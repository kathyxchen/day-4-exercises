...
// RAN THIS FUNCTION JUST TO INSERT THE CITIES BEFOREHAND.
// (note how the foreach loop is commented out now)
  ...
  // Wanted to try to come up with generalized functions, 
  // but then got lazy so...halfhearted attempts
